...
### 6. Frequently Asked Questions (FAQs)
   ...
   Q: What is the "target" platform (that is, where are these data landing) and what are the permissions associated with those? That is, are the files organized and stored 
